...
def create_tables():
  ...
  xindus_db_cursor.execute("Create Table  IF NOT EXISTS RUN(RUN_ID INT PRIMARY KEY,START_DATE VARCHAR(255) NOT NULL,START_TIME VARCHAR(255) NOT NULL,END_DATE VARCHAR(255) NOT NULL,END_TIME VARCHAR(255) NOT NULL,MODE VARCHAR(255) NOT NULL)")
  ...
  xindus_db_cursor.execute("Create Table  IF NOT EXISTS ANDROBENCH_RESULT(RESULT_ID INT, SEQ_READ  VARCHAR(25), SEQ_WRITE VARCHAR(25), RAND_READ VARCHAR(25), SQL_INSERT VARCHAR(25), SQL_UPDATE VARCHAR(25), SQL_DELETE VARCHAR(25))")
