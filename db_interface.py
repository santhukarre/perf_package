...
def create_tables():
  ...
  xindus_db_cursor.execute("Create Table  IF NOT EXISTS BENCHMARK_RESULT(RUN_ID INT,CONSTRAINT fk_category FOREIGN KEY (RUN_ID) REFERENCES RUN(RUN_ID),ID INT,CONSTRAINT fk_category_12 FOREIGN KEY (ID) REFERENCES TOOLS(ID),RESULT_ID INT)")
